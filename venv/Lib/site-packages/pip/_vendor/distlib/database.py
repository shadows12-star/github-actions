    ...
    def provides_distribution(self, name, version=None):
        ...
        if version is not None:
            try:
                ...
                raise DistlibException(f'invalid name or version: {name!r}, {version!r}')
...
class InstalledDistribution(BaseInstalledDistribution):
    ...
    def __repr__(self):
        return f'<InstalledDistribution {self.name!r} {self.version} at {self.path!r}>'
...
class EggInfoDistribution(BaseInstalledDistribution):
    ...
    def __repr__(self):
        return f'<EggInfoDistribution {self.name!r} {self.version} at {self.path!r}>'
...
class DependencyGraph:
    ...
    def to_dot(self, f, skip_disconnected=True):
        ...
        for dist, adjs in self.adjacency_list.items():
            ...
            for other, label in adjs:
                if label is not None:
                    f.write(f'"{dist.name}" -> "{other.name}" [label="{label}"]\n')
                else:
    ...
    def topological_sort(self):
        ...
        while True:
            ...
            logger.debug('Moving to result: %s', [f'{d.name} ({d.version})' for d in to_remove])
